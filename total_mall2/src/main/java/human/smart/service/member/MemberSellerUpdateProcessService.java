...
@Service("mSellerUpdateProcess")
@AllArgsConstructor
public class MemberSellerUpdateProcessService implements MemberService {
	private MemberDAO dao;
	private BCryptPasswordEncoder cryptPasswordEncoder;
	
	@Override
	public MemberVO sellerUpdateProcess(MemberVO memberVO) {
		...
		try {
			...
			newVO=dao.SellerUpdateProcess(memberVO);
