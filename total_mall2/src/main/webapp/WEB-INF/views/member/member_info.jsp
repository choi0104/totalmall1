...
<body>
	...
	<ul>
		...
		<li><span>회원 아이디: </span>${member.member_id}</li>
		<li><span>회원 이름: </span>${member.member_name}</li>
		<li><span>회원 전화번호: </span>${member.handphone}</li>
		<li><span>회원 이메일: </span>${member.email}</li>
